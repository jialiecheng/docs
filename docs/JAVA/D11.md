...
b:Eclipse的特点描述 * 免费 * 纯Java语言编写 * 免安装 * 扩展性强
c:MyEclipse * 在Eclipse基础上追加的功能性插件，对插件收费 * 在WEB开发中提供强大的系统架构平台
...
编写代码
 C:编译和运行
 D:Eclipse的汉化
从Eclipse  3.5 开始，安装目录下就多了一个dropins目录,只要将插件解压后放到到该目录即可。
...
```
## 16_常见对象(Object类的hashCode()方法)(了解)
```java
A:案例演示
public int hashCode()
...
b:不同对象的，hashCode()一般
```
## 17_常见对象(Object类的getClass()方法)(在反射的时候掌握)
```java
A:案例演示
...
```
## 18_常见对象(Object类的toString()方法)(掌握)
```java
A:案例演示
