...
数据传输载体
```
![20191031101220496.png](http://ww1.sinaimg.cn/large/007eYKdZly1gfbyxqu4pbj311m0i974w.jpg)
...
电脑的文件在保存的时候并不是真正的存储文字， 而是存储这些文字对应的二进制 。 那么这些文字对应的二进制到底是多少呢？ 根据文件使用的编码来得到。
...
SAX
```
![20191031104257868.png](http://ww1.sinaimg.cn/large/007eYKdZly1gfbywp1ql9j311m0g2x6q.jpg)
